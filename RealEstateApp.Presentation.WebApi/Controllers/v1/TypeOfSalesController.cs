...
namespace RealEstateApp.Presentation.WebApi.Controllers.v1
{
    ...
    [ApiController]
    [SwaggerTag("Type of sales management")]
    public class TypeOfSalesController : BaseApiController
    {
        [Authorize(Policy = "RequireOnlyAdminAndDeveloper")]
        [HttpGet]
        [SwaggerOperation(
           Summary = "List all sale types",
           Description = "Gets all registered sale types."
        )]
        ...
        [SwaggerOperation(
           ...
           Description = "Gets a sale type using the id as filter."
        )]
        ...
        [SwaggerOperation(
          ...
          Description = "Receives the parameters required to create a new sale type."
        )]
        ...
        [SwaggerOperation(
               ...
               Description = "Receives the parameters required to update an existing sale type."
        )]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(SaveTypeOfSalesViewModel))]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [SwaggerOperation(
            ...
            Description = "Receives the parameters required to delete an existing sale type."
        )]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
